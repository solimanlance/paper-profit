...
class TraderTest {
    ...
    Trader trader1 = new Trader("John", new ArrayList<Stock>());
    Trader trader2 = new Trader("Lance", new ArrayList<Stock>());

    @BeforeEach
    void runBefore() {
        trader2.buyStock(stock2, 5);
        // reset next account id to avoid getting wrong id's in tests
